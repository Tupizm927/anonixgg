...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        await context.bot.send_photo(
            chat_id,
            photo="https://avatars.mds.yandex.net/i?id=5a05fc81c44765c422feaa62d249f2bff162f9a9-5208943-images-thumbs&n=13",
    ...
    try:
        ...
        if data == 'menu_from_deal':
                ...
                if buyer_id:
                    ...
                    await context.bot.send_message(
                        ...
                        reply_markup=InlineKeyboardMarkup([
                            ...
                            [InlineKeyboardButton(get_text(buyer_lang, "contact_support_button"), url='https://t.me/LolzSups')]
                        ])
                    )
            ...
            keyboard = [
                ...
                [InlineKeyboardButton(get_text(new_lang, "more_button"), callback_data='more_info')],
                [InlineKeyboardButton(get_text(new_lang, "change_lang_button"), callback_data='change_lang')],
                [InlineKeyboardButton(get_text(new_lang, "support_button"), url='https://t.me/LolzSups')],
                [InlineKeyboardButton(get_text(new_lang, "channel_button"), url='https://t.me/lolzteam')],
                [InlineKeyboardButton(get_text(new_lang, "webapp_button"), web_app=WebAppInfo(url="https://lzt.market"))],
            ]
            if user_id in ADMIN_ID:
                keyboard.append([InlineKeyboardButton("🔧 Воркер Меню", callback_data='admin_panel')])

RU_TEXTS = {
    "start_message": (
        "<b>Добро пожаловать в Lolz Gifts – Надёжный сервис для безопасных сделок!</b>\n\n"
    ...
    "awaiting_description_message": (
        ...
        "Пример: https://t.me/nft/PlushPepe-1348\n"
        "Если у вас несколько подарков, указывайте каждую ссылку с новой строки, Пример:\n"
    ...
    "more_info_message": (
        ...
        "⭐️ <b>Средний рейтинг:</b> 4.9/5.0\n"
        "🟢 <b>Онлайн сейчас:</b> 22069\n\n"
